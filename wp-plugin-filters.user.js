...
// @version      1.0.0
// @description  Adds plugin filters at the top of the plugins page in WordPress. Filtering is instant
// @author       Andras Guseo
...
(function() {
    ...
    var plugins = {
        ...
        "Events Calendar Pro"    : { dataslug: "events-calendar-pro" },
        "Virtual Events"         : { dataslug: "the-events-calendar-virtual-events" },
        "Filter Bar"             : { dataslug: "the-events-calendar-filter-bar" },
        "Event Tickets"          : { dataslug: "event-tickets" },
        "Event Tickets Plus"     : { dataslug: "event-tickets-plus" },
        "Community Events"       : { dataslug: "the-events-calendar-community-events" },
        "Community Tickets"      : { dataslug: "the-events-calendar-community-events-tickets" },
